...
export const slideStyles = {
  ...
  infoBox: "bg-bg-card rounded-xl p-8 my-8 border-2 border-[#e2e8f0]",
  card: "bg-bg-card border-2 border-[#e2e8f0] rounded-xl p-8 transition-all duration-300"
}
...
export const cardVariants = {
  ...
  glass: "bg-bg-card border-2 border-[#e2e8f0]",
