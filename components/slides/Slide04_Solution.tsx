          ...
          <ThreeColumnGrid className='gap-6'>
            ...
            <div className='bg-gradient-to-br from-blue-500/20 to-blue-500/5 border-2 border-blue-500/50 rounded-xl p-6'>
              <div className='flex flex-col items-center mb-4'>
                <Icon name='dollar' size={32} className='text-blue-400 mb-3' />
          ...
          <div className='bg-gradient-to-br from-blue-500/20 to-blue-500/5 border-2 border-blue-500/50 rounded-xl p-8'>
            ...
            <div className='mb-6'>
              ...
              <div className='grid grid-cols-3 gap-3'>
                <div className='p-2 bg-green-900/30 rounded-lg text-center border border-green-500/30'>
                  <div className='text-xl font-bold text-green-300'>5-8%</div>
                  <div className='text-xs text-gray-400 mt-1'>Conservative</div>
                </div>
                <div className='p-2 bg-blue-900/30 rounded-lg text-center border border-blue-500/30'>
                  <div className='text-xl font-bold text-blue-300'>8-12%</div>
                  <div className='text-xs text-gray-400 mt-1'>Balanced</div>
                </div>
                <div className='p-2 bg-purple-900/30 rounded-lg text-center border border-purple-500/30'>
