    ...
    <Slide id={29} background='bg-black'>
      <SlideContent>
            ...
            <table className='w-full text-sm'>
              ...
              <tbody>
                ...
                <tr className='border-b border-gray-700 bg-green-900/20'>
                  ...
                  <td className='p-3 font-bold text-amber-400'>Variable (2-8% range)</td>
                  <td className='p-3 font-bold text-green-400'>Different correlation + liquidity</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className='mb-12'>
          ...
          <p className='text-lg md:text-xl mb-6 text-center text-gray-300'>Fed Easing Scenario Comparison (2020 example):</p>
          ...
          <TwoColumnGrid className='gap-8 mb-6'>
            <div className='bg-gradient-to-br from-red-500/20 to-red-500/5 border-2 border-red-500/50 rounded-xl p-6'>
              ...
              <div className='space-y-2 text-sm text-gray-300'>
                <p><span className='font-semibold'>60% Equities:</span> $60M × 8% = $4.8M normal | -30% = -$18M downturn</p>
                <p><span className='font-semibold'>30% Bonds:</span> $30M × 4% = $1.2M normal | $30M × 1% = $300K (Fed easing)</p>
                <p><span className='font-semibold'>10% Cash:</span> $10M × 0.5% = $50K normal | $10M × 0.06% = $6K (Fed easing)</p>
                <hr className='my-3 border-red-500/30' />
                <p className='font-bold text-base'>Normal: $6.05M income</p>
                <p className='font-bold text-base text-red-400'>Fed Easing: -$17.7M (net)</p>
              </div>
            </div>
            ...
            <div className='bg-gradient-to-br from-green-500/20 to-green-500/5 border-2 border-green-500/50 rounded-xl p-6'>
              ...
              <div className='space-y-2 text-sm text-gray-300'>
                <p><span className='font-semibold'>60% Equities:</span> $60M × 8% = $4.8M normal | -30% = -$18M downturn</p>
                <p><span className='font-semibold'>30% Bonds:</span> $30M × 4% = $1.2M normal | $30M × 1% = $300K (Fed easing)</p>
                <p><span className='font-semibold text-green-400'>10% MONOLITH:</span> $10M × 4% = $400K normal | $10M × 4-6% = $400-600K (Fed easing)</p>
                <hr className='my-3 border-green-500/30' />
                <p className='font-bold text-base text-green-400'>Normal: $6.4M income</p>
                <p className='font-bold text-base text-green-400'>Fed Easing: -$17.3M to -$17.1M (net) | $400-600K better!</p>
              </div>
            </div>
          </TwoColumnGrid>
          ...
          <div className='p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-2 border-blue-500/50 rounded-xl'>
            <p className='text-lg md:text-xl font-semibold text-center text-blue-400'>
              Key insight: Monolith doesn't replace equities or bonds. It offers different correlation - particularly valuable during Fed easing cycles when cash yields collapse.
            </p>
          </div>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            <div className='bg-gradient-to-br from-purple-500/10 to-purple-500/5 border-2 border-purple-500/30 rounded-xl p-6'>
              ...
              <div className='space-y-2 text-sm text-gray-300'>
                ...
                <p><span className='font-semibold'>Fed easing:</span> Gold: Uncertain (±20%) | Monolith: 4-6% historically</p>
                <p><span className='font-semibold'>Liquidity:</span> Gold: T+2, spread costs | Monolith: 24/7 instant</p>
                <p className='text-green-400 font-semibold mt-3'>✓ Monolith: Positive carry during all cycles</p>
              </div>
            </div>
            ...
            <div className='bg-gradient-to-br from-purple-500/10 to-purple-500/5 border-2 border-purple-500/30 rounded-xl p-6'>
              ...
              <div className='space-y-2 text-sm text-gray-300'>
                ...
                <p><span className='font-semibold'>Fed easing:</span> Bonds: Capital gains + 2-3% yield | Monolith: 4-6% yield</p>
                <p><span className='font-semibold'>Duration risk:</span> Bonds: Capital loss if rates spike | Monolith: Zero duration risk</p>
                <p className='text-green-400 font-semibold mt-3'>✓ Monolith: Different correlation, no duration risk</p>
              </div>
            </div>
            ...
            <div className='bg-gradient-to-br from-purple-500/10 to-purple-500/5 border-2 border-purple-500/30 rounded-xl p-6'>
              ...
              <div className='space-y-2 text-sm text-gray-300'>
                ...
                <p><span className='font-semibold'>Downturn:</span> Private: Default risk spikes | Monolith: Variable (2-8%)</p>
                <p><span className='font-semibold'>Liquidity:</span> Private: Locked 3-7 years | Monolith: Instant</p>
                <p className='text-green-400 font-semibold mt-3'>✓ Monolith: Lower yield but different correlation + instant liquidity</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='bg-gradient-to-r from-blue-500/10 to-green-500/10 border-2 border-green-500/50 rounded-xl p-8'>
          ...
          <blockquote className='text-base text-gray-300 space-y-3'>
            ...
            <p>What you don't have is a yield asset with different correlation that:</p>
            <ul className='list-disc ml-8 space-y-1'>
              <li>Earns 3-5% through utilization pricing, not Fed policy</li>
              <li>Historically maintained 4-6% during Fed easing (2020) when cash paid 0.06%</li>
              <li>Has different correlation to TradFi (genuine diversification)</li>
              <li>Provides 24/7 liquidity (unlike private credit)</li>
              <li>Has positive carry (unlike gold or options)</li>
            </ul>

            <p>The $20M pilot isn't 'betting on crypto.' It's diversifying the cash allocation with a different correlation profile.</p>

            <p className='font-semibold text-green-400'>If we're right, you add $500K-$1M annually to portfolio returns AND have meaningful diversification during Fed easing cycles.</p>
