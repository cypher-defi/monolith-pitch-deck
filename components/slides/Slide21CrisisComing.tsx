    ...
    <Slide id={26} background='bg-black'>
      <SlideContent>
        ...
        <Subtitle size='md' className='mb-12 text-center'>
          When Fed cuts rates, DeFi protocols historically maintained yields through different mechanisms
        </Subtitle>

        <div className='mb-12'>
          <h2 className='text-2xl md:text-3xl font-bold mb-6 text-center'>
            Historical Fed Easing Cycles vs DeFi Yields
          </h2>
            ...
            <div className='bg-gradient-to-br from-yellow-500/20 to-yellow-500/5 border-2 border-yellow-500/50 rounded-xl p-6'>
              ...
              <ul className='space-y-2 text-sm text-gray-300'>
                <li className='flex gap-2' style={{alignItems: 'baseline'}}>
                  ...
                  <span>Fed raised to 5.5%</span>
                </li>
                <li className='flex gap-2' style={{alignItems: 'baseline'}}>
                  <span className='text-green-400 flex-shrink-0'>•</span>
                  <span>Bank savings: 4-5% APY</span>
                </li>
                <li className='flex gap-2' style={{alignItems: 'baseline'}}>
                  <span className='text-red-400 flex-shrink-0'>•</span>
                  <span>DeFi yields: 2-8% (compressed)</span>
                </li>
                <li className='flex gap-2' style={{alignItems: 'baseline'}}>
                  <span className='text-amber-400 font-bold flex-shrink-0'>•</span>
                  <span className='font-bold text-amber-400'>TradFi outperformed during this cycle</span>
                </li>
              </ul>
            </div>
          </ThreeColumnGrid>
        ...
        <div className='mb-12'>
          <h2 className='text-2xl md:text-3xl font-bold mb-6 text-center'>
            Why DeFi Maintained Yields During Fed Easing (2020)
          </h2>
          <p className='text-lg md:text-xl mb-6 text-center text-gray-300'>
            While traditional banks paid 0.10%, DeFi protocols maintained yields through utilization-based pricing:
          </p>
          ...
          <div className='p-6 bg-gradient-to-r from-green-500/10 to-blue-500/10 border-2 border-green-500/50 rounded-xl'>
            <p className='text-lg md:text-xl font-bold text-center text-green-400 mb-2'>
              DeFi yields maintained 10-50x premiums during 2020 Fed easing
            </p>
            ...
            <p className='text-center text-amber-300 text-sm'>
              <strong>Important context:</strong> This performance was specific to Fed easing + crypto bull market conditions. During 2022 Fed hiking, traditional yields outperformed DeFi.
            </p>
          </div>
        </div>
      </SlideContent>
