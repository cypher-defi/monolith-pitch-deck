      ...
      <SlideContent>
        ...
        <div className='p-6 bg-gradient-to-br from-green-500/10 to-blue-500/10 border-2 border-green-500/30 rounded-lg mb-8'>
          ...
          <div className='grid grid-cols-2 gap-6 mb-4'>
            <div className='bg-black/30 p-4 rounded-lg'>
              ...
              <ul className='text-sm text-gray-300 space-y-2'>
                ...
                <li>
                  • Insurance provider partnerships (InsurAce integration)
                </li>
              </ul>
            </div>
            ...
            <div className='bg-black/30 p-4 rounded-lg'>
              <h5 className='text-lg font-bold text-purple-300 mb-3'>
                Post-Launch Recurring (Funded from Operating Margin)
              </h5>
              <ul className='text-sm text-gray-300 space-y-2'>
          ...
          <div className='bg-blue-900/30 p-4 rounded-lg'>
            <h5 className='text-md font-bold text-blue-300 mb-2'>
              Why Insurance & Audits Are Recurrent (Not One-Time)
            </h5>
            ...
            <div className='grid grid-cols-2 gap-4 text-xs text-gray-300'>
              <div>
                ...
                <div>
                  Audits are snapshots. New exploits happen. We re-audit
                  annually.
                </div>
              </div>
              <div>
                <div className='font-bold text-blue-400 mb-1'>
                  2. New protocol integrations
                </div>
                <div>
                  Each time we add Aave, Morpho, or Curve, we audit before
                  routing capital. 3-4x/year.
                </div>
              </div>
              <div>
                <div className='font-bold text-blue-400 mb-1'>
                  3. Insurance scales with TVL
                </div>
                <div>
                  Larger vault = higher coverage needed. Premium grows with AUM.
                </div>
              </div>
              <div>
                <div className='font-bold text-blue-400 mb-1'>
                  4. Threat landscape evolves
                </div>
                <div>
                  Yesterday&apos;s secure protocol has today&apos;s
                  vulnerability. Continuous monitoring is essential.
                </div>
              </div>
            </div>
            <p className='text-sm text-green-300 font-bold mt-4 text-center'>
              This is not a cost to minimize. It&apos;s the insurance + audit
              infrastructure that justifies why institutions choose Monolith
              over DIY Aave.
            </p>
