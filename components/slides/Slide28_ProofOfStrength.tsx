    ...
    <Slide id={26} background="bg-black">
      <SlideContent>
        ...
        <Subtitle size="md" className="mb-12 text-center">
          Empirical evidence of protocol stability through multiple market
          cycles
        </Subtitle>
        ...
        <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-500/5 border-2 border-blue-500/50 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  ...
                  <span>
                    <span className="font-semibold">ETH price:</span> $90 →
                    $3,500
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-blue-400 flex-shrink-0">•</span>
                  <span>
                    <span className="font-semibold">Liquidations:</span> $26M in
                    24 hours
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  ...
                  <span>
                    <span className="font-semibold">Stability:</span> 100%
                    uptime, zero losses
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  ...
                  <span>
                    ...
                    4-8% (during crypto bull cycle)
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-blue-400 flex-shrink-0">•</span>
                  <span>
                    <span className="font-semibold">TVL:</span> $500M → $20B
                    post-crisis
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-purple-500/5 border-2 border-purple-500/50 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  ...
                  <span>
                    <span className="font-semibold">Market cap loss:</span> $60B
                    evaporated
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-red-400 flex-shrink-0">•</span>
                  <span>
                    <span className="font-semibold">Contagion:</span> Celsius,
                    3AC, Voyager failed
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                ...
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-green-400 flex-shrink-0">✓</span>
                  <span>
                    <span className="font-semibold text-green-400">Yield:</span>{" "}
                    3-6% maintained (CeFi froze)
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-purple-400 flex-shrink-0">•</span>
                  <span>
                    <span className="font-semibold">TVL:</span> Stable $10B+
                    (CeFi lost 80%)
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-gradient-to-br from-red-500/20 to-red-500/5 border-2 border-red-500/50 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-red-400 flex-shrink-0">•</span>
                  <span>
                    <span className="font-semibold">Systemic shock:</span> $32B
                    bankruptcy
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-red-400 flex-shrink-0">•</span>
                  <span>
                    <span className="font-semibold">Industry panic:</span> Mass
                    withdrawals
                  </span>
                </li>
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                ...
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  <span className="text-red-400 flex-shrink-0">•</span>
                  <span>
                    <span className="font-semibold">Exchanges:</span> Halted
                    withdrawals
                  </span>
                </li>
              </ul>
          ...
          <div className="bg-gradient-to-br from-green-500/20 to-green-500/5 border-2 border-green-500/50 rounded-xl p-6 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-300">
              <div>
                <span className="font-semibold text-green-400">TVL:</span> $40B+
                (largest DeFi protocol)
              </div>
              <div>
                <span className="font-semibold text-green-400">Uptime:</span>{" "}
                99.99% since 2020
              </div>
              <div>
                <span className="font-semibold text-green-400">Exploits:</span>{" "}
                Zero on core protocol
              </div>
              <div>
                <span className="font-semibold text-green-400">
                  Years live:
                </span>{" "}
                5+ without major incident
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="p-6 bg-gradient-to-r from-green-500/10 to-blue-500/10 border-2 border-green-500/50 rounded-xl">
            <p className="text-xl md:text-2xl font-bold text-center text-green-400 mb-4">
              Battle-tested DeFi protocols have maintained uptime and solvency
              through multiple market cycles.
            </p>
            <h3 className="text-lg md:text-xl font-bold mb-4 text-center">
              Why DeFi Protocol Resilience?
            </h3>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
              <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                ...
                <span>
                  ...
                  transactions on-chain, real-time auditing
                </span>
              </li>
              <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                <span className="text-green-400 flex-shrink-0">✓</span>
                <span>
                  <span className="font-semibold">Non-custodial:</span> No
                  Alameda-style misappropriation possible
                </span>
              </li>
              <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                <span className="text-green-400 flex-shrink-0">✓</span>
              ...
              <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                <span className="text-green-400 flex-shrink-0">✓</span>
                <span>
                  <span className="font-semibold">Collateralization:</span> All
                  loans overcollateralized 110-150%
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border-2 border-blue-500/50 rounded-xl p-8">
          <blockquote className="text-lg md:text-2xl italic text-center text-gray-300 border-l-4 border-green-500 pl-6">
            "Diversification across 5 battle-tested protocols with 5+ year track
            records, insurance backing, and different correlation to traditional
            markets."
            <br />
            <br />
            <span className="text-green-400 font-bold not-italic">
              Different risk profile, different return drivers - complementary
