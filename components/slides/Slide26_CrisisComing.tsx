    ...
    <Slide id={26} background="bg-black">
      <SlideContent>
        ...
        <Subtitle size="md" className="mb-12 text-center">
          When Fed cuts rates, DeFi protocols historically maintained yields
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li className="flex gap-2" style={{ alignItems: "baseline" }}>
                  ...
                  <span className="font-bold text-amber-400">
                    TradFi outperformed during this cycle
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-lg md:text-xl mb-6 text-center text-gray-300">
            ...
            through utilization-based pricing:
          </p>
          ...
          <div className="p-6 bg-gradient-to-r from-green-500/10 to-blue-500/10 border-2 border-green-500/50 rounded-xl">
            ...
            <p className="text-center text-amber-300 text-sm">
              <strong>Important context:</strong> This performance was specific
              to Fed easing + crypto bull market conditions. During 2022 Fed
              hiking, traditional yields outperformed DeFi.
            </p>
          </div>
        </div>
      </SlideContent>
