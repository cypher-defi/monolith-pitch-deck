...
export default function Slide25_Projections() {
  return (
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-purple-500/5 border-2 border-purple-500/50 rounded-xl p-4 md:p-6">
              ...
              <div className="space-y-2 text-xs text-gray-300 text-center md:text-left">
                <div>
                  ...
                  <div className="md:ml-2 text-gray-500">
                    Cons $70M @ 1.25% = $875K
                  </div>
                  <div className="md:ml-2 text-gray-500">
                    Bal $20M @ 1.75% = $350K
          ...
          <div className="p-4 bg-green-900/20 border border-green-500/30 rounded-lg mb-6">
            <p className="text-xs text-green-300 text-center">
              <strong>Cost Impact of Tier Mix:</strong> Only marginal increase
              in insurance costs
              <br />
              • Conservative: 0.08% TVL • Balanced: 0.10% TVL (+0.02%) •
              Aggressive: 0.12% TVL (+0.04%)
              <br />• Example: $100M Balanced vs Conservative = +$20K insurance
              cost, +$250K revenue ={" "}
              <strong className="text-green-400">
                +$230K operating profit improvement
              </strong>
            </p>
          </div>
            ...
            <div className="space-y-4 text-sm text-gray-300">
              <div>
                <span className="font-bold text-blue-400">
                  Management fees are based on BOTH AUM size AND vault tier:
                </span>
                <div className="mt-3 space-y-2">
                  <div className="bg-blue-900/30 p-3 rounded-lg">
                    <div className="font-bold text-blue-300 mb-1">
                      Conservative Tier (Base Pricing):
                    </div>
                    <div className="text-xs text-gray-400">
                      $0-25M: 1.75% • $50-100M: 1.25% • $250M+: 0.85%
                    </div>
                  </div>
                  <div className="bg-purple-900/30 p-3 rounded-lg">
                    ...
                    <div className="text-xs text-gray-400">
                      $0-25M: 2.00% • $50-100M: 1.50% • $250M+: 1.10%
                    </div>
                  </div>
                  <div className="bg-amber-900/30 p-3 rounded-lg">
                    ...
                    <div className="text-xs text-gray-400">
                      $0-25M: 2.25% • $50-100M: 1.75% • $250M+: 1.35%
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-900/20 p-4 rounded-lg border border-green-500/30">
                ...
                <ul className="ml-4 mt-2 text-xs text-gray-400 space-y-1">
                  <li>
                    1. Higher-yield tiers require more active management (daily
                    rebalancing vs monthly)
                  </li>
                  <li>
                    2. Higher insurance costs (0.12% vs 0.08% for Conservative)
                  </li>
                  <li>
                    3. Greater operational complexity (leverage monitoring,
                    liquidation prevention)
                  </li>
                  <li>
                    4. Industry standard: Active strategies command premium fees
                    (hedge funds charge 2% for aggressive, 1% for passive)
                  </li>
                  <li>
                    5. Value-based: Customers earning 17% vs 6% can afford
              ...
              <div className="bg-purple-900/20 p-4 rounded-lg border border-purple-500/30">
                ...
                <ul className="ml-4 mt-2 text-xs text-gray-400 space-y-1">
                  <li>
                    • All projections assume 100% Conservative tier (most
                    conservative)
                  </li>
                  <li>
                    • Tier mix provides 12-25% upside with minimal cost increase
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border-2 border-blue-500/50 rounded-xl p-4">
              <div className="text-center mb-3">
                <div className="text-blue-300 font-bold text-lg">
                  Year 1 ($100M AUM, 100% Conservative)
                </div>
              </div>
              <div className="text-sm text-gray-300">
                Insurance: <span className="text-blue-400 font-bold">$80K</span>{" "}
                (0.08% of TVL)
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-purple-500/5 border-2 border-purple-500/50 rounded-xl p-4">
              <div className="text-center mb-3">
                <div className="text-purple-300 font-bold text-lg">
                  Year 2 ($300-400M AUM, Mixed Tier Example)
                </div>
              </div>
              <div className="text-xs text-gray-300 space-y-1">
                ...
                <div className="pt-2 border-t border-purple-500/30 font-bold text-purple-400">
                  Total: $328K
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-green-500/5 border-2 border-green-500/50 rounded-xl p-4">
              <div className="text-center mb-3">
                <div className="text-green-300 font-bold text-lg">
                  Year 3 ($800M-1B AUM, Mixed Tier Example)
                </div>
              </div>
              <div className="text-xs text-gray-300 space-y-1">
                ...
                <div className="pt-2 border-t border-green-500/30 font-bold text-green-400">
                  Total: $864K
                </div>
              </div>
            </div>
          ...
          <div className="mt-4 p-4 bg-amber-900/20 border border-amber-500/30 rounded-lg mb-8">
            <p className="text-xs text-amber-300 text-center">
              *Insurance costs scale with both AUM growth and tier mix adoption.
              Higher-yield tiers have higher insurance costs (+0.02-0.04% TVL)
              but generate premium management fees (+0.25-0.50%). Operating
              profit improvement from tier mix uplift.
            </p>
          </div>
            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="border-b-2 border-blue-500/50">
                  ...
                  <th className="text-center p-3 text-blue-300">
                    Conservative
                  </th>
              ...
              <tbody className="divide-y divide-gray-700">
                <tr className="bg-blue-900/10">
                  <td colSpan={4} className="p-2 font-bold text-blue-400">
                    Customer Economics
                  </td>
                </tr>
                <tr>
                ...
                <tr className="bg-purple-900/10">
                  <td colSpan={4} className="p-2 font-bold text-purple-400">
                    Monolith Economics
                  </td>
                </tr>
                <tr>
          ...
          <div className="mt-6 p-6 bg-gradient-to-r from-green-500/10 via-blue-500/10 to-purple-500/10 border-2 border-green-500/50 rounded-xl">
            <p className="text-sm text-green-300 text-center">
              ...
              <br />
              <span className="text-white">• Customers win:</span> All tiers
              deliver massive value vs 0% current yields
              <br />
              <span className="text-white">• Monolith wins:</span> Higher-yield
              tiers generate significantly higher operating profits (87-90%
              gross margins maintained)
              <br />
              <span className="text-white">
                • Premium fees (+0.25-0.50%) more than offset incremental costs
                (+$20-40K)
              </span>
              <br />
              <br />
              <strong className="text-green-400">
                This is why offering multiple tiers makes economic sense.
              </strong>
            </p>
          </div>
        </div>
