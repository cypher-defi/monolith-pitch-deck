  ...
  return (
    <Slide id={8} background="bg-black">
      <SlideContent>
        ...
        {/* Revenue Model */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-blue-400 mb-6 text-center">Revenue Model</h3>
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-green-500/20 to-green-500/5 border-2 border-green-500/50 rounded-xl p-6 text-center">
              <h4 className="text-lg font-bold mb-3 text-green-300">Management Fee</h4>
              <div className="text-4xl font-bold text-green-300 mb-2">1.0-1.5%</div>
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-500/5 border-2 border-blue-500/50 rounded-xl p-6 text-center">
              <h4 className="text-lg font-bold mb-3 text-blue-300">Implementation</h4>
              <div className="text-4xl font-bold text-blue-300 mb-2">$25-75K</div>
            ...
            <div className="bg-gradient-to-br from-amber-500/20 to-amber-500/5 border-2 border-amber-500/50 rounded-xl p-6 text-center">
              <h4 className="text-lg font-bold mb-3 text-amber-300">White-Label SDK</h4>
              <div className="text-4xl font-bold text-amber-300 mb-2">$2-15K</div>
        ...
        <div className="mb-10">
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border-2 border-purple-500/30 rounded-xl p-6">
            <div className="grid grid-cols-2 gap-6 mb-4">
              <div>
                <h4 className="text-lg font-bold text-green-400 mb-3">Revenue (1.25% average)</h4>
                <div className="bg-green-900/30 p-4 rounded-lg">
                  <div className="text-3xl font-bold text-green-300">$1.25M/year</div>
                  <div className="text-sm text-gray-400">Management Fee</div>
                </div>
              </div>

              <div>
                <h4 className="text-lg font-bold text-blue-400 mb-3">Operating Costs Breakdown</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-300">Insurance (InsurAce, 0.08% of TVL)</span>
                    <span className="text-gray-300 font-bold">$80K/year</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-300">Recurring Audits (new integrations, quarterly)</span>
                    <span className="text-gray-300 font-bold">$60K/year</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-300">24/7 Monitoring & Infrastructure</span>
                    <span className="text-gray-300 font-bold">$120K/year</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-300">Engineering & Platform Ops</span>
            ...
            <div className="bg-blue-900/30 p-4 rounded-lg mt-4">
              <h5 className="text-sm font-bold text-blue-300 mb-2">Unit Economics</h5>
              ...
              <p className="text-xs text-gray-400 mt-3 text-center">
                Insurance + audits enables 2-week deployment vs 6-month build • Justifies premium positioning vs Yearn/Beefy
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-500/5 border-2 border-blue-500/50 rounded-xl p-4">
              <h4 className="text-lg font-bold text-blue-300 mb-3 text-center">Month 6-9</h4>
              <div className="text-sm space-y-2">
                <div className="text-center mb-3">
                  <div className="text-xs text-gray-400">First Customer (ConnectAssets)</div>
                ...
                <div className="text-xs text-gray-400 text-center mt-2">Pilot, prove model</div>
              </div>
            </div>

            {/* Year 1 */}
            <div className="bg-gradient-to-br from-purple-500/20 to-purple-500/5 border-2 border-purple-500/50 rounded-xl p-4">
              <h4 className="text-lg font-bold text-purple-300 mb-3 text-center">Year 1</h4>
              <div className="text-sm space-y-2">
                <div className="text-center mb-3">
                  <div className="text-xs text-gray-400">Scale to 3 Customers</div>
                ...
                <div className="text-xs text-green-400 font-bold text-center mt-2">✓ PROFITABLE</div>
              </div>
            </div>

            {/* Year 2 */}
            <div className="bg-gradient-to-br from-indigo-500/20 to-indigo-500/5 border-2 border-indigo-500/50 rounded-xl p-4">
              <h4 className="text-lg font-bold text-indigo-300 mb-3 text-center">Year 2</h4>
              <div className="text-sm space-y-2">
                <div className="text-center mb-3">
                  <div className="text-xs text-gray-400">Scale to 8-10 Partners</div>
                ...
                <div className="text-xs text-gray-400 text-center mt-2">Series A ready (15x+ revenue)</div>
              </div>
            </div>

            {/* Year 3 */}
            <div className="bg-gradient-to-br from-green-500/20 to-green-500/5 border-2 border-green-500/50 rounded-xl p-4">
              <h4 className="text-lg font-bold text-green-300 mb-3 text-center">Year 3</h4>
              <div className="text-sm space-y-2">
                <div className="text-center mb-3">
                  <div className="text-xs text-gray-400">Enterprise Scale</div>
                  <div className="text-2xl font-bold text-yellow-400">$1.5B</div>
                  <div className="text-xs text-gray-400">AUM</div>
                </div>
                <div className="flex justify-between text-xs">
                  <span className="text-gray-400">Gross Revenue:</span>
                ...
                <div className="text-xs text-gray-400 text-center mt-2">75%+ net margin, Series B ready</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-purple-900/30 p-4 rounded-lg border border-purple-500/50">
            ...
            <p className="text-gray-300 text-xs text-center">
              This is 11% of operating costs. It demonstrates we follow institutional best practices (audits) and
              transfer remaining risk (insurance). Combined with non-custodial design, this is why institutional
              treasurers allocate capital to Monolith instead of managing Aave themselves.
            </p>
          </div>
        </div>
