              ...
              <div className="flex flex-col">
                ...
                <div className="bg-green-900/30 p-4 rounded-lg mb-2">
                  ...
                  <div className="text-sm text-gray-400">
                    Management Fee (1.44% avg on tiered pricing)
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between gap-3 font-semibold ml-2 pt-1 border-t border-purple-500/30">
                    <span className="text-purple-300 flex-1 text-left">
                  ...
                  <div className="flex justify-between gap-3 font-bold bg-purple-900/30 p-2 rounded">
                    <span className="text-green-400 flex-1 text-left">
                      Gross Profit
                    </span>
                  ...
                  <div className="text-xs font-bold text-blue-300 mb-2 mt-4">
                  ...
                  <div className="flex justify-between gap-3 font-semibold ml-2 pt-1 border-t border-blue-500/30">
                    <span className="text-blue-300 flex-1 text-left">
              ...
              <div className="text-xs text-gray-300 space-y-2">
                <div className="flex gap-2">
                  ...
                  <span>
                    ...
                    shows capital-efficient core product (revenue minus direct
                    costs of insurance + audits)
                  </span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span>
                    ...
                    at $100M AUM improves to 42% at Month 12-15, then 49-61% at
                    Year 2 as platform costs spread across more customers
                  </span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span>
                    <strong className="text-purple-400">
                      Fixed platform costs + variable direct costs
                    </strong>{" "}
                    = healthy SaaS economics with improving leverage
                  </span>
                </div>
              </div>
              <p className="text-xs text-amber-300 mt-3 text-center border-t border-amber-500/30 pt-3">
                Note: Revenue scales with both AUM volume AND vault tier
                selection. Higher-yield tiers command premium management fees
                (Balanced +0.25%, Aggressive +0.50%) to offset higher insurance
                costs.
              </p>
            </div>
          </div>
