  ...
  return (
    <Slide id={11} background='bg-black'>
      <SlideContent>
              ...
              <tbody>
                ...
                <tr className='border-b border-gray-700'>
                  ...
                  <td className='py-3 px-4 bg-green-500/10 text-white'>
                    Over-collateralized: borrowers post $100 to borrow max
                    $70-75
                  </td>
                </tr>
                <tr className='border-b border-gray-700'>
        ...
        {/* KEY BENEFITS */}
        <div className='max-w-4xl mx-auto mb-8 p-8 bg-gradient-to-r from-blue-500/10 to-green-500/10 border-2 border-blue-500/50 rounded-xl'>
